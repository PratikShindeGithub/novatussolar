...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-50 grid size-14 place-items-center rounded-full bg-primary text-primary-foreground transition-transform hover:scale-110"
    >
